...
const babelPaths = [
    ...
    require.resolve('@babel/runtime/helpers/esm/slicedToArray', {
        paths: [babelRuntimeEntry],
    }),
];
...
module.exports = function (webpackEnv) {
    ...
    const contentScripts = fs
        .readdirSync(paths.appContentScriptJs)
        .filter((name) => name.endsWith('.ts') || name.endsWith('.tsx'))
        .reduce((scriptObj, script) => {
            const nameParts = script.split('.');
            scriptObj[nameParts[0]] = path.resolve(paths.appContentScriptJs, script);
            return scriptObj;
        }, {});
    ...
    return {
        ...
        entry: {
            ...contentScripts,
            background: [paths.appBackgroundJs].filter(Boolean),
        },
        output: {
            // The build folder.
        ...
        resolve: {
            ...
            plugins: [
                ...
                new ModuleScopePlugin(paths.appSrc, [paths.appPackageJson, reactRefreshOverlayEntry, ...babelPaths]),
            ],
                ...
                { parser: {} },
                {
                    ...
                    oneOf: [
                        ...
                        // The preset includes JSX, Flow, TypeScript, and some ESnext features.
                        {
                            ...
                            include: [paths.appSrc, path.resolve(__dirname, '../locales')],
        ...
        plugins: [
            ...
            new webpack.DefinePlugin({
                ...env.stringified,
                __HOST_URL__: "'" + (isEnvProduction ? 'https://dmscreen.silas.link' : 'http://127.0.0.1:3000') + "'",
            }),
            ...
            new WebpackManifestPlugin({
                ...
                generate: (seed, files, entrypoints) => {
                    ...
                    const entrypointFiles = Object.keys(entrypoints).reduce((files, entry) => {
